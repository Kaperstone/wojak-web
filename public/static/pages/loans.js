...
var app = (function () {
    ...
    /* src\pages\loans.svelte generated by Svelte v3.44.2 */
    ...
    function instance$4($$self, $$props) {
    	...
    	validate_slots('Loans', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Loans> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Loans extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot(ctx) {
    	...
    	comp = new Loans({ props: comp_props, $$inline: true });
