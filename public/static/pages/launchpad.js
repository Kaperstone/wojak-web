...
var app = (function () {
    ...
    /* src\pages\launchpad.svelte generated by Svelte v3.44.2 */
    ...
    function instance$4($$self, $$props) {
    	...
    	validate_slots('Launchpad', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Launchpad> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Launchpad extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot(ctx) {
    	...
    	comp = new Launchpad({ props: comp_props, $$inline: true });
