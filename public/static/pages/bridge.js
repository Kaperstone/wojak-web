...
(function(l, r) { if (!l || l.getElementById('livereloadscript')) return; r = l.createElement('script'); r.async = 1; r.src = '//' + (self.location.host || 'localhost').split(':')[0] + ':35741/livereload.js?snipver=1'; r.id = 'livereloadscript'; l.getElementsByTagName('head')[0].appendChild(r) })(self.document);
var app = (function () {
    'use strict';
    ...
    /* src\pages\bridge.svelte generated by Svelte v3.44.2 */

    const file$3 = "src\\pages\\bridge.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t0 = text("bridge it");
    			br0 = element("br");
    			t1 = text("\r\nComing one day if Multichain will help us");
    			br1 = element("br");
    			t2 = space();
    			br2 = element("br");
    			t3 = text("\r\nFeaturing the bad boys:\r\n");
    			ul = element("ul");
    			li0 = element("li");
    			li0.textContent = "Avalanche";
    			t5 = space();
    			li1 = element("li");
    			li1.textContent = "Polygon";
    			t7 = space();
    			li2 = element("li");
    			li2.textContent = "Fantom";
    			t9 = space();
    			li3 = element("li");
    			li3.textContent = "Arbitrum";
    			t11 = space();
    			li4 = element("li");
    			li4.textContent = "Harmony";
    			t13 = space();
    			li5 = element("li");
    			li5.textContent = "Cronos";
    			t15 = space();
    			li6 = element("li");
    			li6.textContent = "HECO";
    			t17 = space();
    			li7 = element("li");
    			li7.textContent = "Gnosis";
    			t19 = space();
    			li8 = element("li");
    			li8.textContent = "Ethereum (when it won't cost me a kidney to deploy 😔)";
    			t21 = space();
    			li9 = element("li");
    			li9.textContent = "More one day";
    			add_location(br0, file$3, 0, 9, 9);
    			add_location(br1, file$3, 1, 41, 56);
    			add_location(br2, file$3, 2, 0, 62);
    			add_location(li0, file$3, 5, 4, 103);
    			add_location(li1, file$3, 6, 4, 127);
    			add_location(li2, file$3, 7, 4, 149);
    			add_location(li3, file$3, 8, 4, 170);
    			add_location(li4, file$3, 9, 4, 193);
    			add_location(li5, file$3, 10, 4, 215);
    			add_location(li6, file$3, 11, 4, 236);
    			add_location(li7, file$3, 12, 4, 255);
    			add_location(li8, file$3, 13, 4, 276);
    			add_location(li9, file$3, 14, 4, 345);
    			add_location(ul, file$3, 4, 0, 93);
    		},
    ...
    function instance$4($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Bridge> was created with unknown prop '${key}'`);
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	comp = new Bridge({ props: comp_props, $$inline: true });
