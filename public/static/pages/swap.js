...
var app = (function () {
    ...
    /* src\pages\swap.svelte generated by Svelte v3.44.2 */
    ...
    function instance$4($$self, $$props) {
    	...
    	validate_slots('Swap', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Swap> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Swap extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot(ctx) {
    	...
    	comp = new Swap({ props: comp_props, $$inline: true });
