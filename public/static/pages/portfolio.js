...
var app = (function () {
    ...
    /* src\pages\portfolio.svelte generated by Svelte v3.44.2 */

    const file$3 = "src\\pages\\portfolio.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br0 = element("br");
    			t1 = text("\r\naddress: ");
    			t2 = text(/*myAddress*/ ctx[0]);
    			br1 = element("br");
    			t3 = text("\r\nMy balance: ");
    			t4 = text(/*myBalance*/ ctx[1]);
    			br2 = element("br");
    			t5 = space();
    			br3 = element("br");
    			add_location(br0, file$3, 17, 9, 440);
    			add_location(br1, file$3, 18, 20, 466);
    			add_location(br2, file$3, 19, 23, 495);
    			add_location(br3, file$3, 20, 0, 501);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*myAddress*/ 1) set_data_dev(t2, /*myAddress*/ ctx[0]);
    			if (dirty & /*myBalance*/ 2) set_data_dev(t4, /*myBalance*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let myAddress = "Loading", myBalance = 0;

    	async function init() {
    		$$invalidate(0, myAddress = await signer.getAddress());
    		$$invalidate(1, myBalance = (await contract.balanceOf(myAddress) / Math.pow(10, 18)).toFixed(4));
    	}

    	init();
    	const writable_props = ['address', 'provider', 'signer'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('signer' in $$props) $$invalidate(4, signer = $$props.signer);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('provider' in $$props) $$invalidate(3, provider = $$props.provider);
    		if ('signer' in $$props) $$invalidate(4, signer = $$props.signer);
    		if ('myAddress' in $$props) $$invalidate(0, myAddress = $$props.myAddress);
    		if ('myBalance' in $$props) $$invalidate(1, myBalance = $$props.myBalance);
    	};
    	...
    	return [myAddress, myBalance, address, provider, signer];
    }

    class Portfolio extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { address: 2, provider: 3, signer: 4 });
    		...
    		if (/*address*/ ctx[2] === undefined && !('address' in props)) {
    			console.warn("<Portfolio> was created without expected prop 'address'");
    		}

    		if (/*provider*/ ctx[3] === undefined && !('provider' in props)) {
    			console.warn("<Portfolio> was created without expected prop 'provider'");
    		}

    		if (/*signer*/ ctx[4] === undefined && !('signer' in props)) {
    			console.warn("<Portfolio> was created without expected prop 'signer'");
    		}
    	}
    ...
    function create_else_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 162, 5, 5452);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_15(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 160, 5, 5340);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_if_block_14(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 158, 5, 5186);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_if_block_13(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "Soyboy Face");
    			add_location(img, file, 156, 5, 5039);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_if_block_12(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 154, 5, 4893);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_if_block_11(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 152, 5, 4751);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_if_block_10(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 150, 5, 4600);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 221, 6, 7804);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file, 254, 3, 9455);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file, 252, 3, 9365);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, iframe, anchor);
    		},
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = "/static/images/pirate.webp")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Wojak Pirate Face");
    			add_location(img, file, 250, 3, 9232);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file, 248, 3, 9098);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, iframe, anchor);
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file, 246, 3, 8965);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, iframe, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file, 244, 3, 8827);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, iframe, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(iframe, file, 242, 3, 8662);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, iframe, anchor);
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	comp = new Portfolio({ props: comp_props, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 144, 1, 4125);
    			add_location(br0, file, 165, 17, 5578);
    			add_location(span0, file, 164, 4, 5554);
    			add_location(br1, file, 168, 4, 5626);
    			add_location(br2, file, 168, 8, 5630);
    			add_location(br3, file, 169, 54, 5689);
    			set_style(div1, "margin-bottom", "1rem");
    			add_location(div1, file, 169, 4, 5639);
    			add_location(li0, file, 172, 17, 5786);
    			attr_dev(a0, "href", "/");
    			add_location(a0, file, 172, 5, 5774);
    			add_location(li1, file, 173, 26, 5829);
    			attr_dev(a1, "href", "/dashboard");
    			add_location(a1, file, 173, 5, 5808);
    			add_location(li2, file, 174, 22, 5874);
    			attr_dev(a2, "href", "/stake");
    			add_location(a2, file, 174, 5, 5857);
    			add_location(li3, file, 175, 22, 5922);
    			attr_dev(a3, "href", "/bonds");
    			add_location(a3, file, 175, 5, 5905);
    			add_location(li4, file, 176, 25, 5971);
    			attr_dev(a4, "href", "/soyfarms");
    			add_location(a4, file, 176, 5, 5951);
    			add_location(li5, file, 177, 23, 6016);
    			attr_dev(a5, "href", "/bridge");
    			add_location(a5, file, 177, 5, 5998);
    			set_style(ul, "text-align", "left");
    			attr_dev(ul, "class", "menu");
    			add_location(ul, file, 171, 4, 5727);
    			add_location(br4, file, 186, 4, 6265);
    			add_location(br5, file, 189, 38, 6435);
    			...
    			add_location(div2, file, 188, 5, 6309);
    			add_location(br6, file, 195, 30, 6635);
    			...
    			add_location(div3, file, 194, 5, 6517);
    			set_style(div4, "text-align", "left");
    			add_location(div4, file, 187, 4, 6274);
    			add_location(br7, file, 201, 4, 6727);
    			add_location(br8, file, 202, 4, 6736);
    			add_location(br9, file, 203, 4, 6745);
    			add_location(div5, file, 205, 22, 6806);
    			attr_dev(a6, "href", "/admin");
    			add_location(a6, file, 205, 5, 6789);
    			add_location(br10, file, 206, 66, 6899);
    			add_location(span1, file, 207, 6, 6910);
    			set_style(div6, "overflow", "hidden");
    			set_style(div6, "text-overflow", "ellipsis");
    			add_location(div6, file, 206, 5, 6838);
    			add_location(br11, file, 209, 64, 7077);
    			add_location(span2, file, 210, 6, 7088);
    			set_style(div7, "overflow", "hidden");
    			set_style(div7, "text-overflow", "ellipsis");
    			add_location(div7, file, 209, 5, 7018);
    			set_style(div8, "text-align", "left");
    			add_location(div8, file, 204, 4, 6754);
    			...
    			add_location(div13, file, 147, 3, 4404);
    			...
    			add_location(div14, file, 231, 3, 8357);
