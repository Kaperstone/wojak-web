...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Wojak token";
    			t1 = text("\r\n\r\nA new breed of multiple tokens in a pursuit to create a new sustainable token thats supports and relies on \r\nexiting DeFi platforms and offering for the first time, truly fixed staking APY.");
    			br0 = element("br");
    			t2 = text("\r\nThe token was written from zero with no borrowed code from anywhere, thus the platform is in alpha.");
    			br1 = element("br");
    			t3 = text("\r\nDon't invest more than you can afford to lose.");
    			br2 = element("br");
    			t4 = space();
    			br3 = element("br");
    			t5 = text("\r\nWojak token introduces truly new concepts (probably will be copied like a dozen times to other platforms)");
    			br4 = element("br");
    			t6 = space();
    			br5 = element("br");
    			t7 = text("\r\nThe token stands on 3 main pilars:\r\n");
    			table = element("table");
    			tr = element("tr");
    			td0 = element("td");
    			h30 = element("h3");
    			t8 = text("Supported by the treasury");
    			br6 = element("br");
    			t9 = text("(or PCV)");
    			t10 = space();
    			div0 = element("div");
    			t11 = text("Not backed by the treasury, but supported by the treasury.");
    			br7 = element("br");
    			t12 = text("\r\n                unlike other platforms, our treasury doesn't sit and eats grass and it won't back the token if it falls below \r\n                a certain threshold, the treasury is put into work on different protocols to create\r\n                more tokens which are then sold for WJK, the bought WJK are either sent to `bonds` or\r\n                burnt.");
    			br8 = element("br");
    			t13 = text("\r\n                In other words, creates infinite deflation/price raise.");
    			t14 = space();
    			td1 = element("td");
    			h31 = element("h3");
    			h31.textContent = "Fixed Staking";
    			t16 = space();
    			div1 = element("div");
    			t17 = text("(Exactly 0.25% per day,");
    			br9 = element("br");
    			t18 = text("or 148.771% annually)");
    			t19 = space();
    			div2 = element("div");
    			t20 = text("Because this token is not a modification of a popular or existing and was coded \r\n                from the ground up, it was written to mint 0.25% per epoch (24h), for each staker,\r\n                individually");
    			br10 = element("br");
    			t21 = text("\r\n                In other words, inflates according to the number of tokens staked.");
    			br11 = element("br");
    			t22 = text("\r\n                Replacing predictable inflation with predictable maximum inflation.");
    			br12 = element("br");
    			t23 = space();
    			br13 = element("br");
    			t24 = text("\r\n                So the more is staked, the more inflation there is. Simple.");
    			t25 = space();
    			td2 = element("td");
    			h32 = element("h3");
    			h32.textContent = "Soyfarms";
    			t27 = space();
    			div3 = element("div");
    			t28 = text("Finally, a new kind of farm.");
    			br14 = element("br");
    			t29 = text("\r\n                Most farms nowadays take tax on deposit, tax on withdraw, take your revenue to create\r\n                deflation for the token and print new tokens to reward the farms.");
    			br15 = element("br");
    			t30 = text("\r\n                Our farm performs differently and outperforms other farms previously seen");
    			br16 = element("br");
    			t31 = text("\r\n                Your tokens are invested in the correlated farms to generate revenue, the revenue is \r\n                used to buy on your behalf WJK from the market, which is then put into a different staking\r\n                contract namely `Zoomer`, which offers x2 the staking reward. 0.50% per day.");
    			br17 = element("br");
    			t32 = space();
    			br18 = element("br");
    			t33 = text("\r\n                Because of our high staking rewards we are able to generate greater interest than the native\r\n                farm. (~52.356% to be precise, if price does not change.)");
    			t34 = space();
    			br19 = element("br");
    			t35 = space();
    			a = element("a");
    			a.textContent = "The platform is well documented, for more words of wisdom, refer to our gitbook documentation";
    			t37 = space();
    			h40 = element("h4");
    			h40.textContent = "### Locker";
    			t39 = text("\r\n\r\nGet an extra revenue by locking your staked tokens and share 5% from all SoyFarm profits.\r\n\r\n");
    			h41 = element("h4");
    			h41.textContent = "### Staking";
    			t41 = text("\r\n\r\nHere is a little calculator for you (come on, dare to edit)");
    			br20 = element("br");
    			br21 = element("br");
    			t42 = space();
    			div6 = element("div");
    			...
    			t45 = text(" days = ");
    			span0 = element("span");
    			span0.textContent = "$1,077.78";
    			br22 = element("br");
    			t47 = text("\r\n        That's a profit of ");
    			span1 = element("span");
    			span1.textContent = "$77.78";
    			t49 = space();
    			br23 = element("br");
    			br24 = element("br");
    			t50 = space();
    			div4 = element("div");
    			t51 = text("The formula:");
    			br25 = element("br");
    			t52 = space();
    			span2 = element("span");
    			...
    			t54 = text(" x (1.0025");
    			sup = element("sup");
    			sup.textContent = "days";
    			t56 = text(")");
    			add_location(h1, file$3, 9, 0, 397);
    			add_location(br0, file$3, 12, 80, 610);
    			add_location(br1, file$3, 13, 99, 715);
    			add_location(br2, file$3, 14, 46, 767);
    			add_location(br3, file$3, 15, 0, 773);
    			add_location(br4, file$3, 16, 105, 884);
    			add_location(br5, file$3, 17, 0, 890);
    			add_location(br6, file$3, 22, 66, 1131);
    			attr_dev(h30, "class", "center underline");
    			add_location(h30, file$3, 22, 12, 1077);
    			add_location(br7, file$3, 24, 74, 1259);
    			add_location(br8, file$3, 28, 22, 1619);
    			attr_dev(div0, "class", "justify");
    			add_location(div0, file$3, 23, 12, 1162);
    			attr_dev(td0, "class", "w-third p-1 rounded border align-top");
    			add_location(td0, file$3, 21, 8, 1014);
    			attr_dev(h31, "class", "center underline");
    			add_location(h31, file$3, 33, 12, 1804);
    			add_location(br9, file$3, 34, 55, 1908);
    			attr_dev(div1, "class", "center");
    			add_location(div1, file$3, 34, 12, 1865);
    			add_location(br10, file$3, 39, 28, 2209);
    			add_location(br11, file$3, 40, 82, 2297);
    			add_location(br12, file$3, 41, 83, 2386);
    			add_location(br13, file$3, 42, 16, 2408);
    			attr_dev(div2, "class", "justify mt-1");
    			add_location(div2, file$3, 36, 12, 1955);
    			attr_dev(td1, "class", "w-third p-1 rounded border align-top");
    			add_location(td1, file$3, 32, 8, 1741);
    			attr_dev(h32, "class", "center underline");
    			add_location(h32, file$3, 47, 12, 2597);
    			add_location(br14, file$3, 50, 44, 2722);
    			add_location(br15, file$3, 52, 81, 2912);
    			add_location(br16, file$3, 53, 89, 3007);
    			add_location(br17, file$3, 56, 92, 3316);
    			add_location(br18, file$3, 57, 16, 3338);
    			attr_dev(div3, "class", "justify");
    			add_location(div3, file$3, 49, 12, 2655);
    			attr_dev(td2, "class", "w-third p-1 rounded border align-top");
    			add_location(td2, file$3, 46, 8, 2534);
    			add_location(tr, file$3, 20, 4, 1000);
    			attr_dev(table, "class", "w-full mt-1 border-spacing-0_5 border-separate");
    			add_location(table, file$3, 19, 0, 932);
    			add_location(br19, file$3, 64, 0, 3585);
    			attr_dev(a, "href", "https://kaperstone.gitbook.io/wojak-1/");
    			add_location(a, file$3, 65, 0, 3591);
    			add_location(h40, file$3, 69, 0, 3749);
    			add_location(h41, file$3, 73, 0, 3865);
    			add_location(br20, file$3, 75, 59, 3948);
    			add_location(br21, file$3, 75, 63, 3952);
    			attr_dev(input0, "type", "text");
    			input0.value = "1000";
    			set_style(input0, "outline", "0");
    			set_style(input0, "width", "48px");
    			set_style(input0, "border", "0");
    			set_style(input0, "border-bottom", "1px dashed black");
    			set_style(input0, "padding", "5px 0");
    			set_style(input0, "text-align", "right");
    			add_location(input0, file$3, 78, 19, 4099);
    			attr_dev(input1, "type", "text");
    			set_style(input1, "outline", "0");
    			set_style(input1, "width", "32px");
    			set_style(input1, "border", "0");
    			set_style(input1, "border-bottom", "1px dashed black");
    			set_style(input1, "padding", "5px 0");
    			set_style(input1, "text-align", "right");
    			input1.value = "30";
    			add_location(input1, file$3, 78, 200, 4280);
    			add_location(span0, file$3, 78, 377, 4457);
    			add_location(br22, file$3, 78, 416, 4496);
    			set_style(span1, "color", "green");
    			add_location(span1, file$3, 79, 27, 4529);
    			add_location(br23, file$3, 80, 8, 4599);
    			add_location(br24, file$3, 80, 12, 4603);
    			add_location(br25, file$3, 82, 24, 4674);
    			set_style(span2, "font-size", "13px");
    			add_location(span2, file$3, 83, 12, 4692);
    			add_location(sup, file$3, 83, 64, 4744);
    			set_style(div4, "text-align", "center");
    			add_location(div4, file$3, 81, 8, 4617);
    			set_style(div5, "border", "1px solid #bbb");
    			set_style(div5, "padding", "1rem");
    			add_location(div5, file$3, 77, 4, 4030);
    			set_style(div6, "border", "1px dotted #bbb");
    			set_style(div6, "padding", "5px");
    			set_style(div6, "text-align", "center");
    			add_location(div6, file$3, 76, 0, 3958);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input0, "keyup", /*update*/ ctx[4], false, false, false),
    					listen_dev(input1, "keyup", /*update*/ ctx[4], false, false, false)
    				];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let op, amount, days, profit;

    	function update() {
    		let end = parseFloat(amount.value) * Math.pow(1.0025, parseInt(days.value));
    		$$invalidate(0, op.innerHTML = new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'USD' }).format(end), op);
    		$$invalidate(3, profit.innerHTML = new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'USD' }).format(end - parseInt(amount.value)), profit);
    	}
    	...
    	$$self.$capture_state = () => ({ op, amount, days, profit, update });

    	$$self.$inject_state = $$props => {
    		if ('op' in $$props) $$invalidate(0, op = $$props.op);
    ...
    function create_default_slot(ctx) {
    	...
    	comp = new Home({ props: comp_props, $$inline: true });
